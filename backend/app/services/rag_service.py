            ...
            messages = [
                {
                    ...
                    "content": (
                        ...
                        '   • \"lesion_site\": a very precise singular anatomical noun; never use only \"bulbo\"; prefer \"lateral medulla\" or '
                        ...
                        "   • #1 compares 1 vs 2; #2 compares 2 vs 3 vs 1; #3 compares 3 vs 4 vs 1; #4 explains why #1 addresses most  keyword; "
                        "#5 Very helpful tip, very practical / specific, citing examples, to differentiate 2 most common syndromes in clinical practice accordingly authors in CTX.\n"
                        "#NEVER CITE ctx ou context in your answer.\n"
                        "Very important: always try to find the syndrome most fits all symptoms if possible!\n"
                        "   • In every sentence cite ≤ 15 words from CTX or EN_QUERY explaining your tough choices.\n"
